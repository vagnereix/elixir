defmodule CExlivery.Orders.Item do
  @categorys [:pizza, :hamburger, :carne, :prato_feito, :japonesa, :sobremesa]
  ...
  def build(_description, _category, _unity_price, _quantity),
